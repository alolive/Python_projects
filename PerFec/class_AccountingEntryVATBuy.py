...
# Accounting entry dedicated to VAT buy moves.
...
class AccountingEntryVATBuy( AccountingEntry ):
    ...
    def __init__( self, statemententry, acct, label, ecrnum ):
        ...
        # Isolate VAT to recover.
        # Internal WireLine 4 out of 5.
        iwd['jc'] = 'AC'
        iwd['jl'] = conf.logs['AC']
        iwd['cn'] = '445661'
        iwd['cl'] = conf.accounts['445661'] 
        
        # calculate VAT amount.
        iwd['d'] = round( initialdebit - iwd['d'], 2 ) 
        iwd['c'] = 0
